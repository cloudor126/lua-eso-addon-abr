...
= function()
  ...
  -- Edit box background
  l.editBoxBg = WINDOW_MANAGER:CreateControl("ABREditorEditBoxBg", win, CT_BACKDROP)
  l.editBoxBg:SetAnchor(TOPLEFT, win, TOPLEFT, 10, 40)
  l.editBoxBg:SetAnchor(BOTTOMRIGHT, win, BOTTOMRIGHT, -10, -80)
  l.editBoxBg:SetCenterColor(0.1, 0.1, 0.1, 1)
  l.editBoxBg:SetEdgeColor(0.5, 0.5, 0.5, 1)
  l.editBoxBg:SetEdgeTexture("", 1, 1, 1)
  l.editBoxBg:SetHidden(true)
